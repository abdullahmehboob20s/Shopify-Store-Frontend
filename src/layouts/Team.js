...
function Team() {
  return (
    <div className="py-16 sm:py-24 xl:py-32 relative z-10">
      ...
      <div className="sm:h-[60vh] w-[76%] sm:w-full -z-20 team-slider absolute top-[92%] sm:top-1/2 left-1/2 sm:left-0 -translate-x-1/2 sm:translate-x-0 sm:px-[4%] sm:-translate-y-1/2 sm:grid sm:grid-cols-[3px_3px] sm:justify-between sm:gap-6 flex justify-center items-center space-x-4 sm:space-x-0"></div>
    </div>
  );
}
