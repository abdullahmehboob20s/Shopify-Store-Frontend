  ...
  return (
    <div className="py-32">
      <div className="container">
        <h1 className="text-2xl text-yellow font-JetBrainsMono uppercase mb-7 text-center">
          MELBOURNE SHOPIFY DESIGN AND DEVELOPMENT AGENCY
        </h1>

        <p
          className="text-2xl text-white font-JetBrainsMono text-center max-w-[64rem] w-full mx-auto opacity-80 mb-7"
